    ...
    <div class="space-y-3">
        ...
        <div class="border border-gray-300 rounded-xl overflow-hidden">
            ...
            <div class="divide-y divide-gray-100" id="cardList">
                ...
                @empty
                    <div class="py-12 text-center text-gray-400 text-sm">Belum ada data supplier</div>
                @endforelse
            </div>
    ...
    @push('scripts')
        <script>
            ...
            function hapusSupplier() {
                // ✅ hapus row desktop & card mobile berdasarkan nama target
            ...
            // ✅ FIX #4: definisikan allCards di luar render(), sejajar dengan allRows
            ...
            function render() {
                ...
                // ✅ FIX #1: sinkronkan card via data-name yang sama, bukan filter ulang terpisah
            ...
            function renderPagination(totalPages) {
                ...
                // ✅ FIX #2: tambah spasi di akhir base agar class tidak menempel
                const base =

...
<div class="grid grid-cols-2 gap-5 mb-6">
    <div class="bg-white border border-gray-200 rounded-[24px] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-[155px] p-6">
...
<div class="grid grid-cols-3 gap-5 mb-6">
    <div class="bg-white border border-gray-200 rounded-[24px] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-[150px] p-6">
    ...
    <div
        class="bg-white border border-gray-200 rounded-[24px] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-[150px] p-6 cursor-pointer"
...
<div class="grid grid-cols-12 gap-5">
    ...
    <div class="col-span-6">
        <div class="bg-white border border-gray-200 rounded-[24px] shadow-sm hover:shadow-xl transition-all duration-300 min-h-[390px] overflow-hidden">
    ...
    <div class="col-span-6 space-y-4">
        <div class="bg-white border border-gray-200 rounded-[24px] shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden">
            <div class="px-4 py-3 border-b-2 border-[#9a9a9a]">
                <h2 class="text-[22px] font-semibold text-[#222]">Barang Masuk Terbaru</h2>
            </div>

            <div class="p-4">
                <div class="bg-gray-50 border border-gray-200 rounded-[20px] p-5 flex items-center justify-between min-h-[120px] transition-all duration-300 hover:shadow-md">
...
<div id="barangMasukModal" class="fixed inset-0 hidden items-center justify-center bg-black/20 backdrop-blur-[1px] z-50">
    <div class="w-full max-w-[620px] bg-white rounded-2xl border-2 border-[#b0b0b0] shadow-xl overflow-hidden">
        <div class="flex items-center justify-between px-4 py-3 border-b-2 thin-line">
            ...
            <button type="button" onclick="closeBarangMasukModal()" class="text-[24px] text-[#333] leading-none">&times;</button>
        </div>
...
<div id="barangKeluarModal" class="fixed inset-0 hidden items-center justify-center bg-black/20 backdrop-blur-[1px] z-50">
    <div class="w-full max-w-[620px] bg-white rounded-2xl border-2 border-[#b0b0b0] shadow-xl overflow-hidden">
        <div class="flex items-center justify-between px-4 py-3 border-b-2 thin-line">
            <h3 class="text-[20px] font-semibold text-[#222]">Informasi Barang Keluar</h3>
            <button type="button" onclick="closeBarangKeluarModal()" class="text-[24px] text-[#333] leading-none">&times;</button>
        </div>
        ...
        <div class="p-4">
            ...
            <div class="flex justify-center">
                <button
                    type="button"
                    onclick="closeBarangKeluarModal()"
                    class="w-[180px] h-[46px] border-2 border-[#8f8f8f] rounded-xl font-medium hover:bg-gray-100">
                    Tutup
                </button>
            </div>
...
<div id="stokMenipisModal" class="fixed inset-0 hidden items-center justify-center modal-bg z-50">
    <div class="w-full max-w-[720px] bg-white rounded-2xl border-2 border-[#b0b0b0] shadow-xl overflow-hidden">
        <div class="flex items-center justify-between px-4 py-3 border-b-2 thin-line">
            ...
            <button type="button" onclick="closeStokMenipisModal()" class="text-[24px] text-[#333] leading-none">&times;</button>
        </div>
...
<div id="stokHabisModal" class="fixed inset-0 hidden items-center justify-center modal-bg z-50">
    <div class="w-full max-w-[720px] bg-white rounded-2xl border-2 border-[#b0b0b0] shadow-xl overflow-hidden">
        <div class="flex items-center justify-between px-4 py-3 border-b-2 thin-line">
            ...
            <button type="button" onclick="closeStokHabisModal()" class="text-[24px] text-[#333] leading-none">&times;</button>
        </div>
